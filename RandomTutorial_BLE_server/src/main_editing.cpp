...
void setup() {
  ...
  // Temperature
  #ifdef temperatureCelsius
    bmpService->addCharacteristic(&bmeTemperatureCelsiusCharacteristics);
  ...
  // Humidity
  bmpService->addCharacteristic(&bmeHumidityCharacteristics);
  ...
  if (deviceConnected) {
    if ((millis() - lastTime) > timerDelay) {
      ...
      //Notify temperature reading from BME sensor
        ...
        Serial.print("Temperature Celsius in Steinheim Office: ");
        Serial.print(temp);
        Serial.print(" ºC");
      #else
      ...
      Serial.print(" - Humidity in Steinheim Office: ");
      Serial.print(hum);
      Serial.println(" %");
